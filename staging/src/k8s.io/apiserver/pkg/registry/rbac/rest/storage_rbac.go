...
import (
	...
	"k8s.io/apiserver/pkg/registry/rbac/clusterrole"
	clusterrolepolicybased "k8s.io/apiserver/pkg/registry/rbac/clusterrole/policybased"
	clusterrolestore "k8s.io/apiserver/pkg/registry/rbac/clusterrole/storage"
	"k8s.io/apiserver/pkg/registry/rbac/clusterrolebinding"
	clusterrolebindingpolicybased "k8s.io/apiserver/pkg/registry/rbac/clusterrolebinding/policybased"
	clusterrolebindingstore "k8s.io/apiserver/pkg/registry/rbac/clusterrolebinding/storage"
	"k8s.io/apiserver/pkg/registry/rbac/role"
	rolepolicybased "k8s.io/apiserver/pkg/registry/rbac/role/policybased"
	rolestore "k8s.io/apiserver/pkg/registry/rbac/role/storage"
	"k8s.io/apiserver/pkg/registry/rbac/rolebinding"
	rolebindingpolicybased "k8s.io/apiserver/pkg/registry/rbac/rolebinding/policybased"
	rolebindingstore "k8s.io/apiserver/pkg/registry/rbac/rolebinding/storage"
	rbacregistryvalidation "k8s.io/apiserver/pkg/registry/rbac/validation"
