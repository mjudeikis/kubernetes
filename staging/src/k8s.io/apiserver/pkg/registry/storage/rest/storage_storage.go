...
import (
	...
	csidriverstore "k8s.io/apiserver/pkg/registry/storage/csidriver/storage"
	csinodestore "k8s.io/apiserver/pkg/registry/storage/csinode/storage"
	csistoragecapacitystore "k8s.io/apiserver/pkg/registry/storage/csistoragecapacity/storage"
	storageclassstore "k8s.io/apiserver/pkg/registry/storage/storageclass/storage"
	volumeattachmentstore "k8s.io/apiserver/pkg/registry/storage/volumeattachment/storage"
	volumeattributesclassstore "k8s.io/apiserver/pkg/registry/storage/volumeattributesclass/storage"
