...
import (
	...
	leasestorage "k8s.io/apiserver/pkg/registry/coordination/lease/storage"
	leasecandidatestorage "k8s.io/apiserver/pkg/registry/coordination/leasecandidate/storage"
